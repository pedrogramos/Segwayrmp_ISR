...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'testeturtle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rmp/catkin_ws/src/testeturtle/${idir}'.  ${_report}")
    endif()
...
set(testeturtle_EXPORTED_TARGETS "testeturtle_generate_messages_cpp;testeturtle_generate_messages_eus;testeturtle_generate_messages_lisp;testeturtle_generate_messages_nodejs;testeturtle_generate_messages_py")
...
set(pkg_cfg_extras "testeturtle-msg-extras.cmake")
